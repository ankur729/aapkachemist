...
@Component({
  selector: 'app-send-modified-quotation',
  templateUrl: './send-modified-quotation.component.html',
  styleUrls: ['./send-modified-quotation.component.css']
})
export class SendModifiedQuotationComponent implements OnInit {
  ...
  getVendorEnquiryDetail() {
    ...
    this.api.getVendorModifyEnquiryItemDetail(data).subscribe(
      (response) => {
  ...
  setParmas(dt) {
    ...
    this.enquiry.enquiry_detail.vendor_cashback_amount = dt.data.enquiry_detail.vendor_cashback_amount;
    this.enquiry.enquiry_detail.net_payble_amount = dt.data.enquiry_detail.net_payble_amount;
    this.enquiry.enquiry_detail.apc_cash_used = dt.data.enquiry_detail.apc_cash_used;
  ...
  preSubmitQuotation(postdata:any){
    ...
    this.api.sendQuotationForModifiedOrder(postdata).subscribe(
      (response) => {
