...
@Component({
  selector: 'app-enquiry-quotation-detail',
  templateUrl: './enquiry-quotation-detail.component.html',
  styleUrls: ['./enquiry-quotation-detail.component.css']
})
export class EnquiryQuotationDetailComponent implements OnInit {
