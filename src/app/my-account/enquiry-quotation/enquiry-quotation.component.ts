...
@Component({
  selector: 'app-enquiry-quotation',
  templateUrl: './enquiry-quotation.component.html',
  styleUrls: ['./enquiry-quotation.component.css']
})
export class EnquiryQuotationComponent implements OnInit {
  ...
  respdata:any={
    ...
    'order_data':{'enquiry_id':'','app_confirm_flag':'','delivery_charge':'','delivery_date':'','delivery_time':'','grand_total':'','order_date':'',
                  'order_no':'','order_id':'','order_status':'','sub_total':'','total_discount':'','total_tax':'','net_payble_amount':'','total_apc_discount_amount':''}
  }
  lists:any=[];     
 constructor(private aroute:ActivatedRoute,private router:Router,private loadingBar:LoadingBarService,private api:Api,public global:AppGlobals,
  ...
  setParams(data){
    ...
    this.respdata.order_data.net_payble_amount=data.order_data.net_payble_amount;
    this.respdata.order_data.total_apc_discount_amount=data.order_data.total_apc_discount_amount;
